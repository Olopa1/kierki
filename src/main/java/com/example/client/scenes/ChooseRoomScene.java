...
/**
 * Scene that allows user to choose one of available rooms or create now.
 */
public class ChooseRoomScene implements ScenesHanlder {
    ...
    /**
     * Initializes button for a given room.
     *
     * @param handler      Connection handler of a user.
     * @param sceneManager Manager object that contains that scene.
